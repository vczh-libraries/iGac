...
//  GacOSX
//
//  Created by Robert Bu on 12/13/14.
//  Copyright (c) 2014 Robert Bu. All rights reserved.
//

#ifndef GacOSX_Header_h
#define GacOSX_Header_h

#include "../gac_include.h"

const vint                               SystemIconSize = 24;
...
public:
    ...
    :window(0)
    {
        ...
        boundsComposition->SetColumnOption(4, GuiCellOption::PercentageOption(1.0));
        boundsComposition->SetColumnOption(2, GuiCellOption::MinSizeOption());
        ...
        {
            {
                iconComposition=AddTitleCell(5, INativeWindowListener::Icon, titleBackgroundColor);
                iconComposition->SetAlignmentToParent(Margin(3, 3, 3, 3));
                
                Ptr<INativeImage> icon=GetCurrentController()->ImageService()->CreateImageFromFile(GetApplication()->GetExecutableFolder()+L"/Contents/Resources/BigDoc.png");
            ...
            {
                titleComposition=AddTitleCell(4, INativeWindowListener::Title, titleBackgroundColor);
                ...
                titleElement->SetAlignments(Alignment::Center, Alignment::Center);
                titleComposition->SetOwnedElement(titleElement);
            }
            {
                minimumButton=AddTitleButton(2, titleBackgroundColor, titleColor);
            ...
            {
                maximumButton=AddTitleButton(3, titleBackgroundColor, titleColor);
            ...
            {
                closeButton=AddTitleButton(1, titleBackgroundColor, titleColor);
                closeButton->GetBoundsComposition()->SetAlignmentToParent(Margin(3, 3, 3, 3));
    ...
    GuiWindow::IStyleController* CreateTooltipStyle()
    {
        return 0;
    }

    GuiLabel::IStyleController* CreateShortcutKeyStyle()
    {
        return 0;
    }

    GuiBoundsComposition* GetBoundsComposition()
    {
        return boundsComposition;
    }
    ...
    void AttachWindow(GuiWindow* _window)
    {
        window=_window;
    }

    void InitializeNativeWindowProperties()
    {
