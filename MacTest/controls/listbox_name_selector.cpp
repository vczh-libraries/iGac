...
#ifndef GacOSX_listbox_name_selector_h
#define GacOSX_listbox_name_selector_h
...
private:
    ...
    {
        return wcsicmp(a->GetText().Buffer(), b->GetText().Buffer());
    }
...
void GuiMain()
{
    RunGacWindow<NameSelectorWindow>();
}
