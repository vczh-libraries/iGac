...
//  GacOSX
//
//  Created by Robert Bu on 12/21/14.
//  Copyright (c) 2014 Robert Bu. All rights reserved.
//

#ifndef GacOSX_tooltip_richtext_h
#define GacOSX_tooltip_richtext_h
...
public:
    ...
    :GuiWindow(GetCurrentTheme()->CreateWindowStyle())
    {
        ...
        MoveToScreenCenter();
        List<WString> errors;
        Ptr<GuiResource> resource = GuiResource::LoadFromXml(GetApplication()->GetExecutableFolder()+L"/Contents/Resources/XmlResource.xml", errors);
