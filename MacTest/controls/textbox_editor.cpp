...
//  GacOSX
//
//  Created by Robert Bu on 12/11/14.
//  Copyright (c) 2014 Robert Bu. All rights reserved.
//

#ifndef GacOSX_textbox_editor_h
#define GacOSX_textbox_editor_h
...
private:
    ...
    {
        vint line=wtoi(textGoto->GetText())-1;
...
void GuiMain()
{
    RunGacWindow<TextBoxEditorWindow>();
}
