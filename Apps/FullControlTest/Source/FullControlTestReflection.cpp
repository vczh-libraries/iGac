...
#undef _
			class FullControlTestTypeLoader : public Object, public ITypeLoader
			{
			public:
			...
			bool LoadFullControlTestTypes()
			{
#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA
				if (auto manager = GetGlobalTypeManager())
				{
					return manager->AddTypeLoader(Ptr(new FullControlTestTypeLoader));
				}
#endif
				return false;
			}
