...
#ifndef VCZH_WORKFLOW_COMPILER_GENERATED_FULLCONTROLTESTREFLECTION
#define VCZH_WORKFLOW_COMPILER_GENERATED_FULLCONTROLTESTREFLECTION
...
namespace vl
{
	namespace reflection
	{
		namespace description
		{
			...
			extern bool LoadFullControlTestTypes();
		}
	}
}
